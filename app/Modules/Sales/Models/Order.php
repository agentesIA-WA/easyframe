...
class Order extends BaseModel
{
    ...
    protected $fillable = ['customer_id', 'seller_id', 'framer_id', 'status', 'total_value', 'discount', 'production_date', 'delivery_date', 'delivered_at', 'delivery_observation', 'legacy_id'];
