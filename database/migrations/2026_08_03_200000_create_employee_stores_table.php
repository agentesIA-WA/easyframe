...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('employee_stores')) {
        ...
        // Migra dados existentes de employees.store_id para employee_stores se a coluna existir
        if (Schema::hasColumn('employees', 'store_id') && Schema::hasTable('employee_stores')) {
