                                        ...
                                        <td className="px-4 py-2 text-xs">
                                            <div className="flex gap-2">
                                                <button 
                                                    ...
                                                    className="bg-blue-50 text-blue-600 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-blue-100"
                                                >
                                                    Visualizar
                                                </button>
                                                <button 
                                                    onClick={() => handleEdit(p)}
                                                    className="bg-slate-100 text-slate-600 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-slate-200"
                                                >
                                                    Editar
                                                </button>
                                                <button 
                                                    onClick={() => handleDelete(p.id)}
                                                    className="bg-red-50 text-red-600 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-red-100"
                                                >
                                                    Excluir
                                                </button>
                                            </div>
