                                ...
                                <tr key={s.id} className="hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td className="px-4 py-3 text-xs whitespace-nowrap">
                                        <div className="flex items-center gap-1.5 whitespace-nowrap">
                                            <button onClick={() => setViewingSupplier(s)} className="bg-blue-50 text-blue-600 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-blue-100 transition-colors">Visualizar</button>
                                            <button onClick={() => handleOpenModal(s)} className="bg-slate-100 text-slate-600 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-slate-200 transition-colors">Editar</button>
                                            <button onClick={() => handleDelete(s.id)} className="bg-red-50 text-red-600 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-red-100 transition-colors">Excluir</button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
