        ...
        <div className="w-full space-y-4 pb-20">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-4">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                    ...
                    <div className="md:col-span-3 flex items-center gap-4 bg-slate-50 p-2 rounded-lg border border-slate-100">
                    ...
                    <div className="md:col-span-4 flex gap-3">
                        <div className="flex-1 text-right">
                            <p className="text-[10px] font-black text-slate-400 uppercase leading-tight">Total Geral</p>
                        ...
                        <button
                            ...
                            className="bg-emerald-600 text-white px-4 py-3 rounded font-black text-[10px] uppercase tracking-widest hover:bg-emerald-700 transition shadow-md flex items-center gap-1.5 disabled:opacity-50"
                            title="Enviar resumo do orçamento/pedido via WhatsApp"
                        >
                        ...
                        <button
                            ...
                            className="px-4 py-3 rounded font-black text-[10px] uppercase tracking-widest text-slate-400 hover:text-slate-600 transition"
                        >
                            Cancelar
                        </button>
                        <button
                            ...
                            className="bg-primary-600 text-white px-6 py-3 rounded font-black text-[10px] uppercase tracking-widest hover:bg-primary-700 transition shadow-xl shadow-primary-900/20 disabled:opacity-50"
                        >
                            {loading ? '...' : isEdit ? 'ATUALIZAR' : 'GRAVAR'}
                        </button>
                    </div>
                </div>
            </div>
