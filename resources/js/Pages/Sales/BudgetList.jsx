                                        ...
                                        <div className="flex items-center justify-end gap-1.5 whitespace-nowrap">
                                            ...
                                            {budget.status === 'draft' && (
                                                <button 
                                                    ...
                                                    className="p-1.5 bg-indigo-50 text-indigo-600 rounded-md hover:bg-indigo-100 hover:scale-105 transition-all shadow-2xs"
                                                    title="Converter Orçamento em Pedido de Produção"
                                                >
                                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
