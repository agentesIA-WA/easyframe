                                    ...
                                    <td className="px-2 py-1.5 text-xs whitespace-nowrap text-right">
                                        <div className="flex items-center justify-end gap-1 whitespace-nowrap">
                                            ...
                                            <button 
                                                ...
                                                className="bg-emerald-50 text-emerald-600 border border-emerald-200 px-1.5 py-1 rounded text-[10px] font-bold uppercase tracking-tighter hover:bg-emerald-100 transition-colors flex items-center gap-0.5"
